...
{
    // use static method because we can use WebApplication instance without creating a new class
    public static void InitDb(WebApplication app)
    {
        // this will allow the framework to dispose of the service that we have used inside the scope 
    ...
    {
        // if database does not exist it will create the db
        context.Database.Migrate();

        if (context.Auctions.Any())
        {
            Console.WriteLine("Db already has data, no need to seed.");
            return;
        }
